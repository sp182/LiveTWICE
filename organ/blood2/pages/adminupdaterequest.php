...
<div class="row">
<div class=".col-lg-12">
               <h1 style='color:#e74e63' class="page-header">Edit Requester's Details</h1>
                </div>
  </div>  
				...
				<div class="row">
						...
						while($row=mysqli_fetch_array($result)){
						  ...
						  <td>".$row['organtype']."</td>
						  <td>".$row['message']."</td>
						  <td><a href='adminupdateform.php?id=".$row['id']."'><i class='fa fa-edit' style='color:#e74e63''></i></a></td>
						</tr>
						</tbody>";
						}
